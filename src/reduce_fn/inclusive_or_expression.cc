...
env_t inclusive_or_expression_direct(deque<env_t> &env)
{
	return env[0];
}
reg_sym(inclusive_or_expression_direct);

env_t inclusive_or_expression_exclusive_or(deque<env_t> &env)
{
...
reg_sym(inclusive_or_expression_exclusive_or);
